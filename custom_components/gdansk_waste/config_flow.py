...
class GdanskWasteConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle config flow for Gdansk waste collection."""
        ...
        if user_input is not None:
            ...
            try:
                ...
                if len(candidates) == 1:
                    ...
                    self._candidates = {
                        candidate.unique_id: candidate for candidate in candidates
                    }
    ...
    def _build_user_schema(
        ...
        return vol.Schema(
            {
                vol.Optional(CONF_NAME, default=str(user_input.get(CONF_NAME, ""))): str,
                vol.Required(CONF_STREET, default=str(user_input.get(CONF_STREET, ""))): str,
                vol.Required(
                    CONF_HOUSE_NUMBER,
